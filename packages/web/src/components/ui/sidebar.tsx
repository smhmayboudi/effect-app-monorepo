...
function SidebarGroupAction({
  ...
  return (
    <Comp
      className={cn(
        "absolute top-3.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground ring-sidebar-ring outline-hidden transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
function SidebarMenuBadge({ className, ...props }: ComponentProps<"div">) {
  ...
  return (
    <div
      className={cn(
        "pointer-events-none absolute flex h-5 min-w-5 items-center justify-center rounded-md px-1 text-xs font-medium text-sidebar-foreground tabular-nums select-none",
        direction === "rtl" ? "left-1" : "right-1",

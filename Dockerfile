...
ARG CLIENT_SHARD_MANAGER_ADDRESS_HOST=${CLIENT_SHARD_MANAGER_ADDRESS_HOST:-localhost}
ARG CLIENT_SHARD_MANAGER_ADDRESS_PORT=${CLIENT_SHARD_MANAGER_ADDRESS_PORT:-8080}
...
ARG SERVER_SHARD_MANAGER_ADDRESS_HOST=${SERVER_SHARD_MANAGER_ADDRESS_HOST:-localhost}
ARG SERVER_SHARD_MANAGER_ADDRESS_PORT=${SERVER_SHARD_MANAGER_ADDRESS_PORT:-8080}
...
ARG CLIENT_SHARD_MANAGER_ADDRESS_HOST
ARG CLIENT_SHARD_MANAGER_ADDRESS_PORT
ARG CLIENT_SQLITE_FILENAME
ARG SERVER_ACCOUNT_CACHE_TTL_MS
ARG SERVER_GROUP_CACHE_TTL_MS
ARG SERVER_PERSON_CACHE_TTL_MS
ARG SERVER_SHARD_MANAGER_ADDRESS_HOST
ARG SERVER_SHARD_MANAGER_ADDRESS_PORT
...
ENV CLIENT_SHARD_MANAGER_ADDRESS_HOST=${CLIENT_SHARD_MANAGER_ADDRESS_HOST}
ENV CLIENT_SHARD_MANAGER_ADDRESS_PORT=${CLIENT_SHARD_MANAGER_ADDRESS_PORT}
